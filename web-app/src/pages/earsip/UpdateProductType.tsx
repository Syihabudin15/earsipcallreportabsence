...
import UpsertProductType from "./UpsertProductType";
import type { IProductType } from "../../libs/interface";
...
export default function UpdateProductType() {
  ...
  useEffect(() => {
    ...
    api
      .request({
        ...
        url: `${import.meta.env.VITE_API_URL}/producttype?id=${id}`,
      })
      .then((res) => {
  ...
  return <UpsertProductType record={data as unknown as IProductType} />;
}
