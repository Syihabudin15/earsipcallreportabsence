  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (res?.data) {
        ...
        const getKol = (bill: any) => {
          const rawKol = String(
            bill.col || bill.kol || bill.KD_KOL_EFF || "1",
          ).trim();
          const match = rawKol.match(/\d+/);
          return match ? Number(match[0]) : 1;
        };

        const isNplBilling = (bill: any) => {
        ...
        // ==========================================
        // 2. OLAH TREN TAGIHAN BULANAN 12 BULAN TERAKHIR
        // ==========================================
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex justify-between items-center">
          <div className="space-y-1">
            <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
              Total Pembayaran NPL
            </p>
            <h3 className="text-2xl font-bold text-slate-800">
              {IDRFormat(summary.totalNplPayment)}
            </h3>
          </div>
          ...
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-400">
                Perbandingan total tagihan, pembayaran, dan pembayaran NPL 12
                bulan terakhir
              </p>
            </div>
          ...
          <div className="w-full h-72">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip formatter={(v) => IDRFormat(Number(v))} />
                <Legend
                  iconType="circle"
